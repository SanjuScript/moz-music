...
class _NowPlayingState extends State<NowPlaying>
  ...
  void initState() {
    ...
    colorProvider.startColorChangeTimer();
  }
    ...
    return WillPopScope(
        ...
        child: Scaffold(
            ...
            body: Consumer<ColorProvider>(
              ...
              Color _dColor = isDark
                  ? colorProvider.currentColor.withOpacity(.7)
                      ...
                      SizedBox(
                        ...
                        child: Text(
                          artistHelper(
                              widget
                                  .songModelList[
                                      nowPlayingProvider.currentIndex]
                                  .artist
                                  .toString(),
                              ''),
                          textAlign: TextAlign.center,
                      ...
                      SizedBox(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FavButMusicPlaying(
                                  songFavoriteMusicPlaying: widget
                                          .songModelList[
